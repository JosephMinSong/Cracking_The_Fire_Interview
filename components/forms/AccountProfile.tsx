          ...
          render={({ field }) => (
            <FormItem className="flex flex-col justify-start items-start gap-1 w-full">
              ...
              <Select onValueChange={field.onChange} defaultValue={field.value}>
                ...
                <FormMessage />
                <SelectContent>
                  <SelectItem value="I'm curious about the process">
                    I'm curious about the process
                  </SelectItem>
                  <SelectItem value="I'm preparing for the exams and interviews">
                    I'm preparing for the exams and interviews
                  </SelectItem>
                  <SelectItem value="I'm a volunteer firefighter">
                    I'm a volunteer firefighter
                  </SelectItem>
                  <SelectItem value="I'm a probationary firefighter">
                    I'm a probationary firefighter
                  </SelectItem>
                  <SelectItem value="I'm a career firefighter">
                    I'm a career firefighter
                  </SelectItem>
                  <SelectItem value="I'm a retired firefighter">

...
export default function NavBar() {
    return (
        <nav className="navbar-container flex justify-between items-center mr-5 ml-2 my-2 lg:mx-52">
            ...
            <div>
                <input type="text" name="searchbar" className="border rounded-lg py-0.5 px-2 md:py-2 md:px-16 lg:px-20 lg:pr-32 searchbar bg-orange w-3/4 lg:max-w-full" placeholder="Search..." />
            </div>
